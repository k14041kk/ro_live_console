...
<div class="line-numbers line-numbers-error-<?= $cluster ?>"><span></span><span></span><span></span></div></pre>
    ...
    <script>
        ...
        function getOut<?= $cluster ?>() {
            ...
            fetch('<?= Config::$TOP_PATH ?>app/k14041kk/ro_live_console-cluster_get/<?= $cluster ?>/out', {
        ...
        function getError<?= $cluster ?>() {
            ...
            fetch('<?= Config::$TOP_PATH ?>app/k14041kk/ro_live_console-cluster_get/<?= $cluster ?>/error', {
                method: 'GET', credentials: "include"
            })
                .then(function (response) {
                    return response.text()
